...
- [ ] 7. Website footers:
    - Must include **trademark guidelines** by either linking to
      ...
      [Trademark Usage][]".
    - If your project has been converted to the Series LLC
      model (starting in 2025), use the following **copyright
