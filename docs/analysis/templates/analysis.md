...
- Issues List: [issues list](./issues-list.md)
- Project-doc-url: _PROJECT-DOC-URL_
- Project-website: _PROJECT-WEBSITE_
- Rating: [Rating (1-5)](#rating-values)
- Rfc-spec: [rfc-spec](https://www.rfc-editor.org/rfc/rfc2119)
- Website guidelines:
